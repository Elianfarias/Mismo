...
namespace MoreMountains.FeedbacksForThirdParty
{
	...
	public class MMF_CinemachineImpulse : MMF_Feedback
	{
		...
		public override void OnAddFeedback()
		{
			...
			this.m_ImpulseDefinition.m_RawSignal = Mismo.Core.FeelAssets.Load<NoiseSettings>("MM_6D_Shake");
			...
			this.m_ImpulseDefinition.RawSignal = Mismo.Core.FeelAssets.Load<NoiseSettings>("MM_6D_Shake");
			this.Velocity = new Vector3(5f, 5f, 5f);
			#endif
		}
