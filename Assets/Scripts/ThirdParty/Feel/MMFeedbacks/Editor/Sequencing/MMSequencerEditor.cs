...
namespace MoreMountains.Feedbacks
{
	...
	public class MMSequencerEditor : Editor
	{
		...
		protected virtual void OnEnable()
		{
			...
			_buttonBackground = Mismo.Core.FeelAssets.Load("SequencerButtonBackground") as Texture2D;
			_dotBackground = Mismo.Core.FeelAssets.Load("SequencerDotBackground") as Texture2D;
