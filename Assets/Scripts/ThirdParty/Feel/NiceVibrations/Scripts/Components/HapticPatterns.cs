...
namespace Lofelt.NiceVibrations
{
    ...
    public static class HapticPatterns
    {
        ...
        struct Pattern
        {
            ...
            static Pattern()
            {
                clipJsonTemplate = (Mismo.Core.FeelAssets.Load("nv-pattern-template") as TextAsset).text;
            }
        ...
        {
            emphasisTemplate = (Mismo.Core.FeelAssets.Load("nv-emphasis-template") as TextAsset).text;
            constantTemplate = (Mismo.Core.FeelAssets.Load("nv-constant-template") as TextAsset).text;
