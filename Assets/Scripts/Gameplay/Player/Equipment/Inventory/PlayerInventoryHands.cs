...
namespace Mismo.Gameplay.Player.Equipment.Inventory
{
    public sealed partial class PlayerInventory
    {
        ...
        public bool TryEquipOffhand(int slot,string id)
        {
            ...
            return next.TryEquipOffhand(slot,id)&&Fits(next,false)&&Commit(next,id==null?"Mano secundaria libre.":"Combinación y habilidades actualizadas.",true,GameSound.ItemEquipped);
        }
