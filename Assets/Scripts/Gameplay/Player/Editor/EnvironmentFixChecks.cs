    ...
    public static class EnvironmentFixChecks
    {
        public static void RunBatch()
        {
            try
            {
                ...
                var holder=new GameObject("Test terrain");var material=Resources.Load<Material>("TerrainSurface");
                ...
                var cycle=new GameObject("Cycle").AddComponent<DayNightCycle>();cycle.Initialize(Resources.Load<DayNightSettings>("DayNightSettings"));cycle.SetHour(12);
