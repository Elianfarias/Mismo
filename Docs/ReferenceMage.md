...
El jugador de `VoxelRegion_7319` usa `Assets/Art/Prefabs/Player/Player.prefab`, que referencia las mallas de `Assets/Art/FBX/Characters/Voxel_Adventurer_Animated.fbx`. Se actualizó ese FBX y los materiales de los prefabs Player y VoxelAdventurer. No se reconstruyeron sus componentes de movimiento, combate o inventario.
